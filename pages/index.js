        ...
        <section className="min-h-screen">
          <nav className='py-10 mb-12 flex justify-between dark:text-amber-100'>
            ...
            <ul className='flex items-center'>
              ...
              <li><a className='bg-gradient-to-r from-amber-600 to-yellow-500 text-white px-4 py-2 rounded-md ml-8' href="https://www.cakeresume.com/me/gracejhuo0211">Resume</a></li>
            </ul>
          </nav>
