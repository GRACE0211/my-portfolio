...
<div>
    ...
    <section id="timeline" class="main-section">
      ...
      <div class="timeline-list">
        ...
        <div class="timeline-item">
          ...
          <div class="timeline-right">
            <ul>
              <li>補足核心知識：計算機概論、資料結構、網路、資料庫</li>
    ...
    <section id="story" class="main-section">
      ...
      <div class='story-div'>
        <div>
          過去的工作經歷中，我曾管理 1-3人的團隊，負責工作分配與排程協調，也參與過貨櫃內產品的進出貨流程。當時主要透過試算表進行庫存紀錄，讓我深刻體會到，面對大量資料時若缺乏合適的系統工具，會極大地降低效率。這段經驗也促使我在轉職學習時，<strong style="color:#707070;">格外重視「使用者角度」與「系統效率」的平衡。</strong>
      </div>
      <div>
